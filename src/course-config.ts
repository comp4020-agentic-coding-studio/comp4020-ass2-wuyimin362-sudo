...
export const courseMeta = slopCourseMetaSchema.parse({
  code: "SLOP1039",
  title: "Ruin: A First Course in Losing Money",
  session: "Semester 1",
  year: 2027,
  level: 1,
  ...
  endDate: "2027-05-28",
  description:
    "Every other investing course teaches you to make money. This one refuses. " +
    "Twelve weeks, twelve named ways to lose it, on the premise that you cannot " +
    "price a risk you have never felt. No prior finance assumed; no upside promised.",
  tags: ["risk", "markets", "failure"],
